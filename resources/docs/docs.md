...
The `home-routes` handler in the `did-homepage.routes.home` namespace
...
The `home-page` function will in turn call the `did-homepage.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/did_homepage/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `did-homepage.handler` namespace:
...
Request middleware functions are located under the `did-homepage.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `did-homepage.dev-middleware` namespace found in
